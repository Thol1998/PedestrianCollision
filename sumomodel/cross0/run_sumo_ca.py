...
from sumomodel.cross0.env_singlecar2 import *
...
parser.add_argument('--training_eps', type=int, default=10000,
...
parser.add_argument('--threshold_return', type=int, default=19,
